...
def create_node_group_transparent() -> NodeTree:
    ...
    node_group = bpy.data.node_groups.new(name="TRANSPARENT", type='ShaderNodeTree') # type: ignore
...
def create_material_with_node_group_transparent(material_name:str, node_group:NodeTree) -> bpy.types.Material:
