...
class dmspritedefinition:
	...
	def read(self, tag:str, r:io.TextIOWrapper|None) -> str:
		...
		self.center = None if records[1] == "NULL" else (float(records[1]), float(records[2]), float(records[3]))
		records = property(r, "PARAMS1?", 3)
		self.params1 = None if records[1] == "NULL" else (float(records[1]), float(records[2]), float(records[3]))
		...
		self.params2 = None if records[1] == "NULL" else (float(records[1]), float(records[2]), float(records[3]))
		return ""
