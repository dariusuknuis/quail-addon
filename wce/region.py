...
class region:
	...
	class wall:
		...
		class wxyz:
			...
			def __init__(self):
				self.wxyz = (0.0, 0.0, 0.0) #4

	class obstacle:
		onormalabcd:tuple[float, float, float, float]

		def __init__(self):
			self.onormalabcd = (0.0, 0.0, 0.0, 0.0) #3
			self.overtices = []
	...
	class visnode:
		...
		def __init__(self):
			self.vnormalabcd = (0.0, 0.0, 0.0, 0.0) #3
