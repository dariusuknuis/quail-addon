...
class particleclouddef:
	...
	def write(self, w:io.TextIOWrapper)->str:
		...
		w.write(f"\tSPAWNNORMAL {self.spawnnormal[0]} {self.spawnnormal[1]} {self.spawnnormal[2]}\n")
		...
		w.write(f"\tSPAWNVELOCITY {self.spawnvelocity[0]} {self.spawnvelocity[1]} {self.spawnvelocity[2]}\n")
