...
class particleclouddef:
	...
	def write(self, w:io.TextIOWrapper)->str:
		...
		w.write(f"\tSPAWNBOXMIN? {('NULL' if self.spawnboxmin is None else format(self.spawnboxmin[0], '.8e'))} {('NULL' if self.spawnboxmin is None else format(self.spawnboxmin[1], '.8e'))} {('NULL' if self.spawnboxmin is None else format(self.spawnboxmin[2], '.8e'))}\n")
		w.write(f"\tSPAWNBOXMAX? {('NULL' if self.spawnboxmax is None else format(self.spawnboxmax[0], '.8e'))} {('NULL' if self.spawnboxmax is None else format(self.spawnboxmax[1], '.8e'))} {('NULL' if self.spawnboxmax is None else format(self.spawnboxmax[2], '.8e'))}\n")
		w.write(f"\tBOXMIN? {('NULL' if self.boxmin is None else format(self.boxmin[0], '.8e'))} {('NULL' if self.boxmin is None else format(self.boxmin[1], '.8e'))} {('NULL' if self.boxmin is None else format(self.boxmin[2], '.8e'))}\n")
		w.write(f"\tBOXMAX? {('NULL' if self.boxmax is None else format(self.boxmax[0], '.8e'))} {('NULL' if self.boxmax is None else format(self.boxmax[1], '.8e'))} {('NULL' if self.boxmax is None else format(self.boxmax[2], '.8e'))}\n")
