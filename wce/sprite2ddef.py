...
class sprite2ddef:
	...
	def write(self, w:io.TextIOWrapper)->str:
		...
		w.write(f"\t\tUVORIGIN? {('NULL' if self.renderinfo.uvorigin is None else format(self.renderinfo.uvorigin[0], '.8e'))} {('NULL' if self.renderinfo.uvorigin is None else format(self.renderinfo.uvorigin[1], '.8e'))} {('NULL' if self.renderinfo.uvorigin is None else format(self.renderinfo.uvorigin[2], '.8e'))}\n")
		w.write(f"\t\tUAXIS? {('NULL' if self.renderinfo.uaxis is None else format(self.renderinfo.uaxis[0], '.8e'))} {('NULL' if self.renderinfo.uaxis is None else format(self.renderinfo.uaxis[1], '.8e'))} {('NULL' if self.renderinfo.uaxis is None else format(self.renderinfo.uaxis[2], '.8e'))}\n")
		w.write(f"\t\tVAXIS? {('NULL' if self.renderinfo.vaxis is None else format(self.renderinfo.vaxis[0], '.8e'))} {('NULL' if self.renderinfo.vaxis is None else format(self.renderinfo.vaxis[1], '.8e'))} {('NULL' if self.renderinfo.vaxis is None else format(self.renderinfo.vaxis[2], '.8e'))}\n")
